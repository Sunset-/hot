...
(function () {
    ...
    var TimeTrigger = Object.assign(new EventEmitter(), {
        ...
        initDatePicker: function initDatePicker() {
            ...
            this.on('set-date', function (date, slient) {
                $datetimepicker.val(date);
                _this5.emit('change-date', date, slient);
            });
        },
        ...
        initToolbar: function initToolbar() {
            ...
            $prev.on('click', function () {
                var time = _this7.state.currentTime - _this7.options.timeStep * 1000;
                if (time < 0) {
                    time = 86400000 + time;
                    var d = new Date(_this7.state.currentDate);
                    d.setDate(d.getDate() - 1);
                    _this7.setDate(d, true);
                }
                _this7.setTime(time);
            });
        ...
        initEvents: function initEvents() {
            ...
            this.on('change-date', function (date, slient) {
         ...
         * @param  time 
         */
        setDate: function setDate(time, slient) {
            var date = time;
            if (!isNaN(time)) {
                date = new Date(time);
            }
